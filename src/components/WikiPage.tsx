...
export function WikiPage({ initialGameData }: WikiPageProps) {
  return (
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          {initialGameData && (
            <div style={{ 
              ...
              {initialGameData.plants.length} crops • {initialGameData.pets.length} pets • {initialGameData.gears.length} gears • {initialGameData.eggs.length} eggs • {initialGameData.mutations.length} mutations
            </div>
          )}
        </div>
            ...
            onMouseLeave={(e) => {
              ...
              <div style={{ textAlign: 'center', width: '100%' }}>
                ...
                <p style={{ 
                  ...
                  Essential tools and equipment that enhance your gardening experience.
                </p>
              </div>
            </div>
          </Link>
            ...
            onMouseLeave={(e) => {
              ...
              <div style={{ textAlign: 'center', width: '100%' }}>
                ...
                <p style={{ 
                  ...
                  Discover crop mutations, their triggers, and how to unlock rare varieties.
                </p>
              </div>
            </div>
          </Link>
