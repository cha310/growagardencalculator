    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="hidden md:block">
          <table className="w-full text-left table-fixed">
            <thead className="bg-gray-700/50">
              <tr>
                <th className="p-4 text-left text-white font-semibold text-sm">Image</th>
                <th className="p-4 text-left text-white font-semibold text-sm">Name</th>
                <th className="p-4 text-left text-white font-semibold text-sm">Trait</th>
                <th className="p-4 text-center text-white font-semibold text-sm">Rarity</th>
                <th className="p-4 text-center text-white font-semibold text-sm">Obtainable</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="space-y-8 mb-12">
        ...
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
          <h2 className="text-3xl font-bold text-white mb-6">About Pets in Grow a Garden</h2>
        ...
        {/* How Pets Work */}
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
          <h2 className="text-3xl font-bold text-white mb-6">How Do Pets Work in Grow a Garden?</h2>
          <div className="text-gray-300 text-lg leading-relaxed space-y-4">
        ...
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
          <h2 className="text-3xl font-bold text-white mb-6">Why Are Pets Important in Grow a Garden?</h2>
          <div className="text-gray-300 text-lg leading-relaxed space-y-4">
            <p>
