      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-16 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {/* Crops Section */}
            <Link href="/grow-a-garden-wiki-crops">
            ...
            {/* Pets Section */}
            <Link href="/grow-a-garden-wiki-pets">
            ...
            {/* Gears Section */}
            <Link href="/grow-a-garden-wiki-gears">
            ...
            {/* Eggs Section */}
            <Link href="/grow-a-garden-wiki-eggs">
            ...
            {/* Mutations Section */}
            <Link href="/grow-a-garden-wiki-mutations">
            ...
            {/* Values Section */}
            <Link href="/grow-a-garden-values">
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover:border-indigo-500 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer aspect-square flex items-center">
                <div className="text-center w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              ...
              <Link href="/grow-a-garden-stock" className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors inline-block">
                View Stock
              </Link>
            </div>
            ...
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
              ...
              <Link href="/grow-a-garden-codes" className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors inline-block">
                View Codes
              </Link>
            </div>
          </div>
        ...
        <div className="mt-16 mb-12">
          ...
          <div className="space-y-4 mb-8">
            ...
            <Link href="/grow-garden-summer-harvest">
            ...
            {/* Bizzy Bee Event */}
            <Link href="/grow-garden-Bizzy-Bee-Event">
            ...
            {/* Lunar Glow Event */}
            <Link href="/grow-garden-Lunar-Glow-Event">
            ...
            {/* Blood Moon Event */}
            <Link href="/grow-garden-Blood-Moon-Event">
            ...
            {/* Angry Plant Event */}
            <Link href="/grow-garden-Angry-Plant-Event">
            ...
            {/* Easter Event 2025 */}
            <Link href="/grow-garden-Easter-Event-2025">
