              ...
              >
                <Link 
                  ...
                  className={`transition-colors px-3 py-2 text-sm flex items-center ${
                    pathname === '/grow-a-garden-wiki' || pathname === '/grow-a-garden-wiki-crops' || pathname === '/grow-a-garden-wiki-pets' || pathname === '/grow-a-garden-wiki-gears' || pathname === '/grow-a-garden-wiki-eggs' || pathname === '/grow-a-garden-wiki-mutations' || pathname === '/grow-a-garden-values' || pathname === '/grow-a-garden-codes' || pathname === '/grow-a-garden-stock'
                      ? 'text-yellow-300 border-b-2 border-yellow-300' 
                      : 'text-gray-300 hover:text-yellow-300'
                  }`}
                  onClick={scrollToTop}
                ...
                {showWikiDropdown && (
                  ...
                  >
                    ...
                    <Link 
                      href="/grow-a-garden-wiki-mutations" 
                      className="block px-4 py-3 text-sm text-gray-300 hover:text-yellow-300 hover:bg-gray-700 transition-colors"
                      onClick={scrollToTop}
                    >
                      ✨ Mutations
