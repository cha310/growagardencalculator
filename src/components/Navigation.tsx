              ...
              >
                <Link 
                  ...
                  className={`transition-colors px-3 py-2 text-sm flex items-center ${
                    location.pathname === '/grow-a-garden-wiki' || location.pathname === '/grow-a-garden-wiki-crops' || location.pathname === '/grow-a-garden-wiki-pets' || location.pathname === '/grow-a-garden-wiki-gears'
                      ? 'text-yellow-300 border-b-2 border-yellow-300' 
                      : 'text-gray-300 hover:text-yellow-300'
                  }`}
                  onClick={scrollToTop}
